...
describe('pairings', () => {
  ...
  scenario('creates a pairing', async (scenario: StandardScenario) => {
    const result = await createPairing({
      input: {
        ...
        updatedAt: '2023-12-05T14:39:37.393Z',
      },
    })
    ...
    expect(result.updatedAt).toEqual(new Date('2023-12-05T14:39:37.393Z'))
  })
  ...
  scenario('updates a pairing', async (scenario: StandardScenario) => {
    ...
    const result = await updatePairing({
      id: original.id,
      input: { updatedAt: '2023-12-06T14:39:37.393Z' },
    })

    expect(result.updatedAt).toEqual(new Date('2023-12-06T14:39:37.393Z'))
  })
