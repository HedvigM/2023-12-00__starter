...
describe('events', () => {
  ...
  scenario('creates a event', async () => {
    const result = await createEvent({
      input: {
        name: 'String',
        date: '2023-12-05T14:39:19.054Z',
        updatedAt: '2023-12-05T14:39:19.054Z',
      },
    })

    expect(result.name).toEqual('String')
    expect(result.date).toEqual(new Date('2023-12-05T14:39:19.054Z'))
    expect(result.updatedAt).toEqual(new Date('2023-12-05T14:39:19.054Z'))
  })
